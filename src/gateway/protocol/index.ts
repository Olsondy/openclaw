...
import {
  ...
  type ChannelAuthStatusParams,
  ChannelAuthStatusParamsSchema,
  type ChannelAuthStatusResult,
  ChannelAuthStatusResultSchema,
  ...
  type SkillsHubSearchParams,
  SkillsHubSearchParamsSchema,
  type SkillsHubInstallParams,
  SkillsHubInstallParamsSchema,
...
export const validateChannelAuthStatusParams = ajv.compile<ChannelAuthStatusParams>(
  ChannelAuthStatusParamsSchema,
);
...
export const validateSkillsHubSearchParams = ajv.compile<SkillsHubSearchParams>(SkillsHubSearchParamsSchema);
export const validateSkillsHubInstallParams = ajv.compile<SkillsHubInstallParams>(SkillsHubInstallParamsSchema);
...
export type {
  ...
  ChannelAuthStatusParams,
  ChannelAuthStatusResult,
  WebLoginStartParams,
  WebLoginWaitParams,
  AgentSummary,
  AgentsFileEntry,
